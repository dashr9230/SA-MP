...
#define RPC_UpdateScoresPingsIPs "\x9B" //#define RPC_Unk9B "\x9B"
#define RPC_SvrStats "\x66" //#define RPC_Unk66 "\x66"
#define RPC_Unk28 "\x28"
#define RPC_Unk82 "\x82"
#define RPC_ClientMessage "\x5D" //#define RPC_Unk5D "\x5D"
#define RPC_WorldTime "\x5E" //#define RPC_Unk5E "\x5E"
#define RPC_Unk5F "\x5F"
#define RPC_Unk3F "\x3F"
#define RPC_Unk97 "\x97"
#define RPC_ScmEvent "\x60" //#define RPC_Unk60 "\x60"
#define RPC_Weather "\x98" //#define RPC_Unk98 "\x98"
...
#define RPC_DamageVehicle "\x6A" //#define RPC_Unk6A "\x6A"
#define RPC_Unk18 "\x18"
#define RPC_EnterVehicle "\x1A" //#define RPC_Unk1A "\x1A"
#define RPC_ExitVehicle "\x9A" //#define RPC_Unk9A "\x9A"
#define RPC_Unk89 "\x89"
#define RPC_Unk8A "\x8A"
#define RPC_Unk8B "\x8B"
#define RPC_Chat "\x65" //#define RPC_Unk65 "\x65"
#define RPC_RequestClass "\x80" //#define RPC_Unk80 "\x80"
#define RPC_RequestSpawn "\x81" //#define RPC_Unk81 "\x81"
#define RPC_EditAttachedObject "\x74" //#define RPC_Unk74 "\x74"
#define RPC_EditObject "\x75" //#define RPC_Unk75 "\x75"
#define RPC_SelectObject "\x1B" //#define RPC_Unk1B "\x1B"
#define RPC_Unk1C "\x1C"
#define RPC_UnkAA "\xAA"
#define RPC_ClientCheck "\x67" //#define RPC_Unk67 "\x67"
#define RPC_UnkAB "\xAB"
#define RPC_UnkAC "\xAC"
#define RPC_PlayerDamage "\x73" //#define RPC_Unk73 "\x73"
#define RPC_SetInteriorId "\x76" //#define RPC_Unk76 "\x76"
#define RPC_ScriptCash "\x1F" //#define RPC_Unk1F "\x1F"
#define RPC_ClickMap "\x77" //#define RPC_Unk77 "\x77"
#define RPC_VehicleDestroyed "\x88" //#define RPC_Unk88 "\x88"
#define RPC_PickedUpWeapon "\x61" //#define RPC_Unk61 "\x61"
#define RPC_PickedUpPickup "\x83" //#define RPC_Unk83 "\x83"
#define RPC_MenuSelect "\x84" //#define RPC_Unk84 "\x84"
#define RPC_MenuQuit "\x8C" //#define RPC_Unk8C "\x8C"
#define RPC_DialogResponse "\x3E" //#define RPC_Unk3E "\x3E"
#define RPC_ClickPlayer "\x17" //#define RPC_Unk17 "\x17"
#define RPC_ClientJoin "\x19" //#define RPC_Unk19 "\x19"
#define RPC_NPCJoin "\x36" //#define RPC_Unk36 "\x36"
#define RPC_Spawn "\x34" //#define RPC_Unk34 "\x34"
#define RPC_Death "\x35"
#define RPC_ServerCommand "\x32" //#define RPC_Unk32 "\x32"
#define RPC_ClickTextDraw "\x53" //#define RPC_Unk53 "\x53"
#define RPC_CameraTarget "\xA8" //#define RPC_UnkA8 "\xA8"
#define RPC_ActorDamage "\xB1" //#define RPC_UnkB1 "\xB1"

#define RPC_ScrUnkA7 "\xA7"
#define RPC_ScrUnk38 "\x38"
#define RPC_ScrUnk90 "\x90"
#define RPC_ScrUnk91 "\x91"
#define RPC_ScrSetGravity "\x92" //#define RPC_ScrUnk92 "\x92"
...
#define RPC_ScrAddGangZone "\x6C" // RPC_ScrUnk6C "\x6C"
#define RPC_ScrRemoveGangZone "\x78" // RPC_ScrUnk78 "\x78"
#define RPC_ScrFlashGangZone "\x79" // RPC_ScrUnk79 "\x79"
#define RPC_ScrStopFlashGangZone "\x55" // RPC_ScrUnk55 "\x55"
...
#define RPC_ScrInitMenu "\x4C" // RPC_ScrUnk4C "\x4C"
#define RPC_ScrShowMenu "\x4D" // RPC_ScrUnk4D "\x4D"
#define RPC_ScrHideMenu "\x4E" // RPC_ScrUnk4E "\x4E"
